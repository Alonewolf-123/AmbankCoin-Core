...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted AMBK to zAMBK");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zAMBK");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received AMBK from zAMBK");
    case TransactionRecord::ZerocoinSpend_Change_zAmbk:
        return tr("Minted Change as zAMBK from zAMBK Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zAMBK to AMBK");
    default:
        return QString();
    }
}
...
{
    QString str = BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->ambk + wtx->debit, false, separators);
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::EditRole:
        ...
        case Amount:
            return qint64(rec->ambk + rec->debit);
        }
        break;
    case Qt::ToolTipRole:
    ...
    case Qt::ForegroundRole:
        ...
        if (index.column() == Amount && (rec->ambk + rec->debit) < 0) {
