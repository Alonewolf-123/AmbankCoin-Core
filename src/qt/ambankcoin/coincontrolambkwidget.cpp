...
#include "qt/ambankcoin/forms/ui_coincontrolambkwidget.h"

CoinControlAmbkWidget::CoinControlAmbkWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlAmbkWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select AMBK Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("AMBK");
    ...
    ui->labelValueAfter->setText("0.00 AMBK");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 AMBK");
    ui->labelValueFee->setText("0.00 AMBK");
...
CoinControlAmbkWidget::~CoinControlAmbkWidget()
{
    delete ui;
}
