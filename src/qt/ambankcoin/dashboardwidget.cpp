    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of AMBK staked."));  // Amount of AMBK and zAMBK staked.
    ...
    // ui->labelAmbk->setVisible(false);
    // ui->labelZambk->setVisible(false);
    ...
    ui->labelAmountZambk->setText("0 zAMBK");
    ui->labelAmountAmbk->setText("0 AMBK");
    ...
    ui->btnHowTo->setText(tr("How to get AMBK or zAMBK"));
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("AMBK");
    set1 = new QBarSet("zAMBK");
