...
#ifndef AMBANKCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define AMBANKCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //AMBANKCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
