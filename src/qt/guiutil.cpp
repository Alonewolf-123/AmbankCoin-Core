...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a AMBANKCOIN address (e.g. %1)").arg("E7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
bool openConfigfile()
{
    ...
    /* Open ambankcoin.conf with the associated application */
