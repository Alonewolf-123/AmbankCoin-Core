...
#ifndef AMBANKCOIN_ZAMBKWALLET_H
#define AMBANKCOIN_ZAMBKWALLET_H
...
public:
    CzAMBKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAMBK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAMBK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //AMBANKCOIN_ZAMBKWALLET_H
