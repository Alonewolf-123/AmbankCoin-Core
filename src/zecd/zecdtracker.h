...
#ifndef AMBANKCOIN_ZAMBKTRACKER_H
#define AMBANKCOIN_ZAMBKTRACKER_H
...
public:
    CzAMBKTracker(std::string strWalletFile);
    ~CzAMBKTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAMBKWallet* zAMBKWallet = NULL);
...
#endif //AMBANKCOIN_ZAMBKTRACKER_H
