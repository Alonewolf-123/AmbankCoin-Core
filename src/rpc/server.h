...
extern UniValue DoZambkSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
// extern UniValue setzambkseed(const UniValue& params, bool fHelp);
// extern UniValue getzambkseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
// extern UniValue searchdzambk(const UniValue& params, bool fHelp);
// extern UniValue dzambkstate(const UniValue& params, bool fHelp);
