...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AMBANKCOIN features */
        {"ambankcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ambankcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ambankcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ambankcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ambankcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ambankcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ambankcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ambankcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ambankcoin", "startmasternode", &startmasternode, true, true, false},
        {"ambankcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ambankcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ambankcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ambankcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ambankcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ambankcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ambankcoin", "preparebudget", &preparebudget, true, true, false},
        {"ambankcoin", "submitbudget", &submitbudget, true, true, false},
        {"ambankcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ambankcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ambankcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ambankcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ambankcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ambankcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ambankcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ambankcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ambankcoin", "mnsync", &mnsync, true, true, false},
        {"ambankcoin", "spork", &spork, true, true, false},
        {"ambankcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // {"zerocoin", "getzambkseed", &getzambkseed, false, false, true},
        // {"zerocoin", "setzambkseed", &setzambkseed, false, false, true},
        // {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        // {"zerocoin", "searchdzambk", &searchdzambk, false, false, true},
        // {"zerocoin", "dzambkstate", &dzambkstate, false, false, true},
