...
public:
    ...
    int AmbankCoinBadBlockTime() const { return nAmbankCoinBadBlockTime; }
    int AmbankCoinBadBlocknBits() const { return nAmbankCoinBadBlocknBits; }
...
protected:
    ...
    unsigned int nAmbankCoinBadBlocknBits;
