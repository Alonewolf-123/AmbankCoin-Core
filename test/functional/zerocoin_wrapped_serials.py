...
from fake_stake.base_test import AMBANKCOIN_FakeStakeTest

class zAMBKwrappedSerialsTest(AMBANKCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAMBKs..." % DENOM_TO_USE)
